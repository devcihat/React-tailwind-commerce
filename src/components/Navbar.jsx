        ...
        <section className="aw-header bg-white border-b border-gray-200 shadow-md">
          <header className="container mx-auto flex items-center justify-between flex-wrap px-2 py-4 lg:p-6 ">
            <div id="mobile-menu__toggler" className="block lg:hidden">
              <button id="mobile-menu__open" className="px-3 py-1 w-18 border rounded text-white bg-red-500 border-transparent hover:bg-red-400 transition">
                      Menu
                  </button>
              <button id="mobile-menu__close" className="hidden px-3 py-1 w-20 border rounded text-white bg-purple-300 border-transparent hover:bg-purple-900 transition">
                      Close
                  </button>
            </div>
            ...
            <nav id="mobile-menu__items" className="aw-header__nav   hidden w-full block flex-grow lg:flex lg:items-center lg:w-auto order-3 lg:order-2">
              <ol className="text-lg lg:space-x-16 mx-auto">
                <li className="block mb-4 mt-3 lg:inline-block lg:mb-0 lg:mt-0 mr-4">
                  <NavLink to="/" className="text-gray-700 hover:text-gray-900 transition">Home</NavLink>
                </li>
      
                <li className="block mb-4 lg:inline-block  lg:mb-0 mr-4">
                  <NavLink to="/about" className="text-gray-700 hover:text-gray-900 transition">About</NavLink>
                </li>
      
                <li className="block mb-4 lg:inline-block lg:mb-0 mr-4">
                  <NavLink to="/todaydeals" className="text-gray-700 hover:text-gray-900 transition">Today's Deals</NavLink>
                </li>
      
                <li className="block mb-4 lg:inline-block lg:mb-0 mr-4">
                  <NavLink to="/shop/mobile" className="text-gray-700 hover:text-gray-900 transition">Products & Shop</NavLink>
                </li>

                <li className="block lg:inline-block lg:mb-0 mr-4">
                  <NavLink to="/contact" className="text-gray-700 hover:text-gray-900 transition">Contact</NavLink>
                </li>
              </ol>
            </nav>
